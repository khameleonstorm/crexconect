...
export default function DashboardNav({modal, details}) {
  ...
  const handleContact = () => {
    ...
    if (input == "yes") {
      window.location.assign("https://wa.me/message/GSTDRMQTKM7QD1")
    }
  }
    ...
    <div className={styles.container}>
      ...
      <div className={styles.logo}>
        <div className={styles.image}>
          <Image src={details.photoURL ? details.photoURL : '/assets/future.jpg'} layout="fill" objectFit="cover" alt="Avatar!" />
        </div>
